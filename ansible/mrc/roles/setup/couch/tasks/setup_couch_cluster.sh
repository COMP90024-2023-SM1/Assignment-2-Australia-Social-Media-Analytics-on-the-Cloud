...
sudo docker create \
  ...
  --env ERL_FLAGS="-setcookie \"${COOKIE}\" -name \"couchdb@${CURRENT_NODE}\" -kernel inet_dist_listen_min 9100 -kernel inet_dist_listen_max 9100 -kernel inet_dist_use_interface {0,0,0,0}" \
  couchdb:${VERSION}
